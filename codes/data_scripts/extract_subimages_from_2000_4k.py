...
def main():
    ...
    if mode == 'single':
        ...
        GT_folder = '../../datasets/2000-4K/HR'
        LR_folder = '../../datasets/2000-4K/LR_x2'
        save_GT_folder = '../../datasets/2000-4K/HR_sub'
        save_LR_folder = '../../datasets/2000-4K/LR_x2_sub'
        scale_ratio = 2
        ...
        for y in w_space:
            ...
            cv2.imwrite(
                osp.join(opt['save_folder'],
                         ...
                         [int(cv2.IMWRITE_JPEG_QUALITY), 100]) # the real quality is based on our original image set. Just keep it. 
